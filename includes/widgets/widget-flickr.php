...
/*-----------------------------------------------------------------------------------
	...
	Description: Display a chosen set of Flickr photos.
	Version: 1.0
	Author: TJ
...
// Load the widget
add_action( 'widgets_init', 'tj_flickr_widgets' );

// Register widget
function tj_flickr_widgets() {
	register_widget( 'TJ_flickr_Widget' );
}

// Widget class
class tj_flickr_widget extends WP_Widget {
...
function TJ_flickr_Widget() {

	// Widget settings
	$widget_ops = array(
		'classname' => 'tj_flickr_widget',
		'description' => __('Display your Flickr photos.', 'framework')
	);
	...
	$control_ops = array( 
		'width' => 300, 
		'height' => 350, 
		'id_base' => 'tj_flickr_widget' 
	);

	// Create the widget
	$this->WP_Widget( 'tj_flickr_widget', __('ThemeJug - Flickr Photos', 'framework'), $widget_ops, $control_ops );
